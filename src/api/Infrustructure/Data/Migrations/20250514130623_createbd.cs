        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    id_biblio = table.Column<string>(type: "text", nullable: true),
                    Id_inv = table.Column<string>(type: "text", nullable: false),
                    date_emp = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2025, 5, 14, 13, 6, 22, 602, DateTimeKind.Utc).AddTicks(5370)),
